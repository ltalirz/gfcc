...
template<typename T>
void gf_guess_ea(ExecutionContext& ec, const TiledIndexSpace& MO, const TAMM_SIZE nvir, double omega, 
              double gf_eta, int pi, std::vector<T>& p_evl_sorted_vir,
